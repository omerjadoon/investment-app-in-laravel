            ...
            // Modification > Data
                ...
                data.innerHTML =
                    '<style media=all type=text/css>' +
                        ...
                        '}' +
                    '</style>' +
                    "<div style='animation: rotate 1s ease-in-out 0s infinite backwards; border: " + loaderScreenWidth + "px solid rgba(20, 20, 20, " + loaderScreenOpacity + "); border-top-color: rgba(0, 255, 0, " + loaderScreenOpacity + "); border-radius: 50%; height: 75px; margin: 0 auto; margin-bottom: " + loaderScreenMargin + "px; width: 75px'> </div>" +
