...
<body>
	<nav class="navbar navbar-expand-lg sticky-top navbar-dark justify-content-center" style="background: #28a745">
                  ...
                  <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                      <div class="form-row">
								...
								<div class="form-row">
									<div class="form-holder ">
										<input id="paynow-btn" style="background: #28a745;color: white" class="btn btn-success" type="submit" class="submit" value="Pay Now">
									</div>

									
									<div class="form-holder">
										<img src="images/sstr.jpg" class="img-responsive" style="width: 100%; float:right;height: auto; ">
									</div>
                      ...
                      <div class="form-row">
			            ...
			            <section>
			                <div class="inner">
								...
								<div class="form-row ">
									<h3 style="color:#28a745;">INVESTMENT AGREEMENT</h3>
								<p>
